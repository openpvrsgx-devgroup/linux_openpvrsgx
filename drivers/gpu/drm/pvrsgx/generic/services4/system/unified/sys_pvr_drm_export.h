...
#define PVR_DRM_DISP_IOCTL DRM_IO(DRM_COMMAND_BASE + PVR_DRM_DISP_CMD)

#define PVR_DRM_BC_IOCTL DRM_IO(DRM_COMMAND_BASE + PVR_DRM_BC_CMD)

#define PVR_DRM_IS_MASTER_IOCTL DRM_IO(DRM_COMMAND_BASE + PVR_DRM_IS_MASTER_CMD)
...
#else
#define PVR_DRM_DBGDRV_IOCTL DRM_IO(DRM_COMMAND_BASE + PVR_DRM_DBGDRV_CMD)
#endif
...
int SYSPVRBridgeDispatch(struct drm_device *dev, IMG_VOID *arg,
	 struct drm_file *pFile);
int SYSPVRDCDriverIoctl(struct drm_device *dev, IMG_VOID *arg,
	struct drm_file *pFile);
int SYSPVRBCDriverIoctl(struct drm_device *dev, IMG_VOID *arg,
	struct drm_file *pFile);
int SYSPVRIsMaster(struct drm_device *dev, IMG_VOID *arg,
	   struct drm_file *pFile);
int SYSPVRUnprivCmd(struct drm_device *dev, IMG_VOID *arg,
	    struct drm_file *pFile);
...
int BC_Video_Bridge(struct drm_device *dev, IMG_VOID *arg,
