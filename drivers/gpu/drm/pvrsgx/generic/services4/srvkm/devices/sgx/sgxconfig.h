...
#define SGX_PERCONTEXT_3DPARAMETERS_HEAP_BASE_REV1 \
	(SGX_SHARED_3DPARAMETERS_HEAP_BASE_REV1 + SGX_SHARED_3DPARAMETERS_SIZE)
...
#define SGX_KERNEL_DATA_HEAP_BASE_REV1 \
	(0x32000000 + SGX_KERNEL_DATA_HEAP_OFFSET)
#define SGX_KERNEL_DATA_HEAP_SIZE_REV1 \
...
#if defined(SUPPORT_SGX_GENERAL_MAPPING_HEAP)
#if ((SGX_CGBUFFER_HEAP_BASE + SGX_CGBUFFER_HEAP_SIZE) >= \
