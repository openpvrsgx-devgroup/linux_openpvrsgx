	     ...
	     IMG_UINT32 ui32AreaFlags)
{
	...
	OSInvalidateCPUCacheRangeKM(psLinuxMemArea, pvCpuVAddr,
	    ui32Bytes);
	...
	IMG_UINT32 ui32AreaFlags)
{
	...
	eError = OSAllocMem(0, sizeof(*pvPageList) * ui32PageCount,
	    (IMG_VOID **)&pvPageList, &hBlockPageList,
	    "Array of pages");
	if (eError != PVRSRV_OK) {
...
#if defined(DEBUG_LINUX_MEMORY_ALLOCATIONS)
	DebugMemAllocRecordAdd(DEBUG_MEM_ALLOC_TYPE_ALLOC_PAGES, pvPageList, 0,
	       0, NULL, PAGE_ALIGN(ui32Bytes), "unknown", 0);
#endif
...
failed_alloc_pages:
	...
	(IMG_VOID) OSFreeMem(0, sizeof(*pvPageList) * ui32PageCount, pvPageList,
	     hBlockPageList);
