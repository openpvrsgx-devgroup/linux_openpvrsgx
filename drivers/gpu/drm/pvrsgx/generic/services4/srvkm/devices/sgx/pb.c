...
static IMPLEMENT_LIST_INSERT(PVRSRV_STUB_PBDESC) static IMPLEMENT_LIST_REMOVE(
	PVRSRV_STUB_PBDESC)
	...
	IMG_UINT32 *ui32SharedPBDescSubKernelMemInfosCount)
{
	...
	*phSharedPBDesc = (IMG_HANDLE)psResItem;
	...
	psResItemCreateSharedPB = ResManRegisterRes(
...
static PVRSRV_ERROR SGXCleanupSharedPBDescKM(PVRSRV_STUB_PBDESC *psStubPBDescIn)
{
	...
	PVRSRVFreeSharedSysMemoryKM(
	psStubPBDescIn->psBlockKernelMemInfo);
	...
	PVRSRVFreeSharedSysMemoryKM(
	psStubPBDescIn->psSharedPBDescKernelMemInfo);
	     ...
	     IMG_DEV_VIRTADDR sHWPBDescDevVAddr)
{
	...
	psSGXDevInfo = (PVRSRV_SGXDEV_INFO *)((PVRSRV_DEVICE_NODE *)hDevCookie)
	       ->pvDevice;
	...
	*phSharedPBDesc = (IMG_HANDLE)psResItem;
	...
	if (OSAllocMem(PVRSRV_OS_NON_PAGEABLE_HEAP, sizeof(PVRSRV_STUB_PBDESC),
	       (IMG_VOID **)&psStubPBDesc, 0,
	...
	if (OSAllocMem(PVRSRV_OS_NON_PAGEABLE_HEAP,
	       sizeof(PVRSRV_KERNEL_MEM_INFO *) *
	       ui32SharedPBDescSubKernelMemInfosCount,
	       (IMG_VOID **)&psStubPBDesc->ppsSubKernelMemInfos, 0,
	       "Array of Kernel Memory Info") != PVRSRV_OK) {
