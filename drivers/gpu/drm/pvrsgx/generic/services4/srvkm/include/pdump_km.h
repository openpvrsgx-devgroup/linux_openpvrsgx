...
PVRSRV_ERROR
PDumpMemPDEntriesKM(PDUMP_MMU_ATTRIB *psMMUAttrib, IMG_HANDLE hOSMemHandle,
...
PVRSRV_ERROR
PDumpMemPTEntriesKM(PDUMP_MMU_ATTRIB *psMMUAttrib, IMG_HANDLE hOSMemHandle,
	    IMG_CPU_VIRTADDR pvLinAddr, IMG_UINT32 ui32Bytes,
	    IMG_UINT32 ui32Flags, IMG_BOOL bInitialisePages,
	    IMG_HANDLE hUniqueTag1, IMG_HANDLE hUniqueTag2);
...
PVRSRV_ERROR PDumpRegKM(IMG_CHAR *pszPDumpRegName, IMG_UINT32 dwReg,
	IMG_UINT32 dwData);
...
PVRSRV_ERROR PDumpMallocPageTable(PVRSRV_DEVICE_IDENTIFIER *psDevId,
	  ...
	  IMG_UINT32 ui32Offset,
	  IMG_CPU_VIRTADDR pvLinAddr,
	  IMG_UINT32 ui32NumBytes, IMG_UINT32 ui32Flags,
	  IMG_HANDLE hUniqueTag);
...
#else
#if (((defined(LINUX) || defined(__QNXNTO__)) || defined(GCC_IA32)) || \
     defined(GCC_ARM))
