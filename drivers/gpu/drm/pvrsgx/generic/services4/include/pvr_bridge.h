...
#define PVRSRV_BRIDGE_MULTI_MANAGE_DEV_MEM \
	PVRSRV_IOWR(PVRSRV_BRIDGE_CORE_CMD_FIRST + 33)
#define PVRSRV_BRIDGE_CORE_CMD_RESERVED_1 \
	PVRSRV_IOWR(PVRSRV_BRIDGE_CORE_CMD_FIRST + 34)
#define PVRSRV_BRIDGE_CORE_CMD_RESERVED_2 \
	PVRSRV_IOWR(PVRSRV_BRIDGE_CORE_CMD_FIRST + 35)
#define PVRSRV_BRIDGE_CORE_CMD_RESERVED_3 \
	PVRSRV_IOWR(PVRSRV_BRIDGE_CORE_CMD_FIRST + 36)
#define PVRSRV_BRIDGE_CORE_CMD_RESERVED_4 \
	PVRSRV_IOWR(PVRSRV_BRIDGE_CORE_CMD_FIRST + 37)
#define PVRSRV_BRIDGE_CORE_CMD_RESERVED_5 \
	PVRSRV_IOWR(PVRSRV_BRIDGE_CORE_CMD_FIRST + 38)
#define PVRSRV_BRIDGE_CORE_CMD_RESERVED_6 \
	PVRSRV_IOWR(PVRSRV_BRIDGE_CORE_CMD_FIRST + 39)
#define PVRSRV_BRIDGE_CORE_CMD_RESERVED_7 \
	PVRSRV_IOWR(PVRSRV_BRIDGE_CORE_CMD_FIRST + 40)
...
typedef PVRSRV_MULTI_MANAGE_DEV_MEM_REQUESTS
	PVRSRV_BRIDGE_IN_MULTI_MANAGE_DEV_MEM;
...
typedef struct PVRSRV_BRIDGE_OUT_MULTI_MANAGE_DEV_MEM_TAG {
	...
	PVRSRV_MANAGE_DEV_MEM_RESPONSE
	sMemResponse[PVRSRV_MULTI_MANAGE_DEV_MEM_MAX_DIRECT_SIZE];
