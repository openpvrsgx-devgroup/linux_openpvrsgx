...
int PVRSRV_BridgeCompatDispatchKM(struct drm_device *dev, void *arg,
	  struct drm_file *pFile);
...
#endif
int PVRDRMIsMaster(struct drm_device *dev, IMG_VOID *arg,
	   struct drm_file *pFile);
int PVRDRMUnprivCmd(struct drm_device *dev, IMG_VOID *arg,
	    struct drm_file *pFile);
int PVRDRM_Dummy_ioctl(struct drm_device *dev, IMG_VOID *arg,
	       struct drm_file *pFile);
#else
...
#if defined(PVR_DISPLAY_CONTROLLER_DRM_IOCTL)
extern int PVR_DRM_MAKENAME(DISPLAY_CONTROLLER, _Ioctl)(struct drm_device *dev,
	void *arg,
	struct drm_file *pFile);
#endif
#endif
...
/* IOCTL numbers */
#define DRM_IOCTL_PVR_SRVKM \
	DRM_IOWR(DRM_COMMAND_BASE + DRM_PVR_SRVKM, PVRSRV_BRIDGE_PACKAGE)
#define DRM_IOCTL_PVR_IS_MASTER \
	DRM_IOW(DRM_COMMAND_BASE + DRM_PVR_IS_MASTER, drm_pvr_dummy_arg)
#define DRM_IOCTL_PVR_UNPRIV \
	DRM_IOWR(DRM_COMMAND_BASE + DRM_PVR_UNPRIV, drm_pvr_unpriv_cmd)

#if defined(PDUMP)
#define DRM_IOCTL_PVR_DBGDRV \
	DRM_IOWR(DRM_COMMAND_BASE + DRM_PVR_DBGDRV, IOCTL_PACKAGE)
#endif

#if defined(PVR_DISPLAY_CONTROLLER_DRM_IOCTL)
#define DRM_IOCTL_PVR_DISP \
	DRM_IOWR(DRM_COMMAND_BASE + DRM_PVR_DISP, drm_pvr_display_cmd)
#endif
#endif /* !defined(SUPPORT_DRI_DRM_EXT) */
