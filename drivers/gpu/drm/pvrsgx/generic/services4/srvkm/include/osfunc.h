...
IMG_VOID *OSMapPhysToLin(IMG_CPU_PHYADDR BasePAddr, IMG_SIZE_T ui32Bytes,
...
PVRSRV_ERROR OSAllocPages_Impl(IMG_UINT32 ui32Flags, IMG_SIZE_T ui32Size,
	       IMG_UINT32 ui32PageSize, IMG_PVOID *ppvLinAddr,
...
PVRSRV_ERROR OSFreeMem_Impl(IMG_UINT32 ui32Flags, IMG_SIZE_T ui32Size,
...
PVRSRV_ERROR OSBaseFreeContigMemory(IMG_SIZE_T ui32Size,
	    IMG_CPU_VIRTADDR LinAddr,
	    IMG_CPU_PHYADDR PhysAddr);

IMG_PVOID MapUserFromKernel(IMG_PVOID pvLinAddrKM, IMG_SIZE_T ui32Size,
...
IMG_VOID UnmapUserFromKernel(IMG_PVOID pvLinAddrUM, IMG_SIZE_T ui32Size,
