...
#define SGX_SP_FIFO_MAXALLOWEDBYTES \
	(SGX_SP_FIFO_DWSIZE * 4) - SGX_SP_FIFO_RESERVEBYTES

#define SGX_EXTRACT_FIFO_COUNT(x) \
	(((x) & SGX_INT_TA_FREEVCOUNT_MASK) >> SGX_INT_TA_FREEVCOUNT_SHIFT)
/*!<
